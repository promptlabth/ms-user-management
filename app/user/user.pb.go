...
func (x *CreateUserReq) GetFirebaseId() string {
	if x != nil {
		return x.FirebaseId
	}
	return ""
...
func (x *CreateUserReq) GetProfilePic() string {
	if x != nil && x.ProfilePic != nil {
		return *x.ProfilePic
	}
	return ""
...
func (x *CreateUserReq) GetPlatform() string {
	if x != nil && x.Platform != nil {
		return *x.Platform
	}
	return ""
...
func (x *CreateUserReq) GetAccessToken() string {
	if x != nil && x.AccessToken != nil {
		return *x.AccessToken
	}
	return ""
...
func (x *CreateUserReq) GetStripeId() string {
	if x != nil && x.StripeId != nil {
		return *x.StripeId
	}
	return ""
...
var file_protos_user_proto_rawDesc = []byte{
	...
	0x64, 0x75, 0x63, 0x74, 0x5f, 0x69, 0x64, 0x22, 0xb6, 0x02, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x12, 0x1f, 0x0a, 0x0b, 0x66, 0x69, 0x72,
	...
	0x22, 0x41, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	...
	0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x61, 0x70,
...
var file_protos_user_proto_depIdxs = []int32{
	...
	4, // 4: user.UserService.CreateUser:output_type -> user.CreateUserRes
